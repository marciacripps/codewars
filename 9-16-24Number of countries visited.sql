-- How many foreign countries has each person visited? https://www.codewars.com/kata/66c71c893759d440748154f8/train/sql
-- Description
...
--select on the people table 
select p.name
from peopele p

--left join with visits 
select p.name, v.country_id 
from people p   
